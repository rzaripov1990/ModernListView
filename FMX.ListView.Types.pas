...
{$IFDEF MSWINDOWS}
  ...
  FLocalRect.Left := Round(FLocalRect.Left * SceneScale) / SceneScale;
  FLocalRect.Top := Round(FLocalRect.Top * SceneScale) / SceneScale;
  FLocalRect.Width := NewRect.Width;
  FLocalRect.Height := NewRect.Height;
{$ENDIF}
end;
